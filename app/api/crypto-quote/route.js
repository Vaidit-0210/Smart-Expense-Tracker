...
export async function GET(request) {
    ...
    try {
        ...
        if (!exchangeRate) {
            ...
            throw new Error("Could not retrieve exchange rate. API limit reached or invalid symbol.");
        }
        ...
        return NextResponse.json({ error: `Failed to fetch crypto data: ${error.message}` }, { status: 500 });
    }
}